<template>
    <v-timeline :align-top="phoneOnly" :dense="phoneOnly" class="e-timeline" :class="{'phone': phoneOnly}" reverse>
        <v-timeline-item v-for="(item, i) in data" :key="i" :color="item.color" :icon="item.icon" fill-dot>
